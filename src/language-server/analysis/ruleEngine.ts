...
export class FilterRuleEngine {
  ...
  detectConflicts(): RuleConflict[] {
    // TODO(#132): We need to check values for conflicts as well, for example if you have a partial rule searching for "staves" and expect a "Quarterstaves" hide rule later to hide it
